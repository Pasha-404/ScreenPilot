...
Бинарники находятся в `runtime/` только на рабочей машине и исключены из Git. Они не должны загружаться программой во время работы и не должны включаться в инсталлятор без отдельной лицензионной проверки на этапе 6.
...
| Лицензии | См. `THIRD_PARTY_NOTICES.md`; до поставки пользователю требуется полный комплект уведомлений. |
